                    ...
                    <form id="create-form">
                        ...
                        <div class="input-style-1 mb-4">
                            ...
                            <input type="text" placeholder="Enter Category name" id="en_category_name"
                                class="form-control @error('en_category_name') is-invalid @enderror" name="en_category_name"
                                value="{{ old('en_category_name') }}" />
                        ...
                        <div class="input-style-1 mb-4">
                            ...
                            <input type="text" placeholder="Enter Category name" id="sp_category_name"
                                class="form-control @error('sp_category_name') is-invalid @enderror" name="sp_category_name"
                                value="{{ old('sp_category_name') }}" />
                        ...
                        <div class="input-style-1 mb-4">
                            ...
                            <input type="text" placeholder="Enter Category name" id="fr_category_name"
                                class="form-control @error('fr_category_name') is-invalid @enderror" name="fr_category_name"
                                value="{{ old('fr_category_name') }}" />
                        ...
                        <div class="input-style-1 mb-4">
                            ...
                            <input type="text" placeholder="Enter Category name" id="ca_category_name"
                                class="form-control @error('ca_category_name') is-invalid @enderror" name="ca_category_name"
                                value="{{ old('ca_category_name') }}" />
...
@push('script')
    <script>
        ...
        function showCategoryStatusChangeAlert(id) {
            event.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    categoryStatusChange(id);
                }
            });
        }

        function categoryStatusChange(id) {
            let url = "{{ route('admin.categories.category.status', ':id') }}";
            $.ajax({
                type: "POST",
                url: url.replace(':id', id),
                success: function(resp) {
